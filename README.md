...
- **6-(1). [Stylegan2-ada]Change a dog's facial expression | [Github](https://github.com/sw-song/TIA/blob/main/category_10_image_generation/06_Generate_Dog_with_StyleGAN2-ada/stylegan2-ada-change-a-dog-s-facial-expression.ipynb) | [Kaggle](https://www.kaggle.com/code/songseungwon/stylegan2-ada-change-a-dog-s-facial-expression/notebook)**
```
